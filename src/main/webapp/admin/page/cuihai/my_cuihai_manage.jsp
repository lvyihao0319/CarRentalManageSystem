...
<script type="text/html" id="format_jieren_num">
  {{#  if(d.jierenId!= null){ }}
	 {{d.jieren.num_}} 
  {{#  } else { }}
  {{#  } }}
</script>
<script type="text/html" id="format_jieren_name">
  {{#  if(d.jierenId!= null){ }}
	 {{d.jieren.trueName}} 
  {{#  } else { }}
  {{#  } }}
...
<script type="text/html" id="format_userSub_date">
  {{#  if(d.userSub!= null){ }}
		{{d.userSub.subDateTime}} 
  {{#  } else { }}
		已还
  {{#  } }}
</script>
			  ...
			  table.render({
			   ...
			   cols: [[
			       ...
			       {checkbox: true, width:50, fixed: true}
			          ,{field:'userId', title: '账号', width:80 ,style:'font-size: 12px;',templet: '#format_jieren_num'}
				      ,{field:'userId', title: '租用人姓名', width:80 ,style:'font-size: 12px;',templet: '#format_jieren_name'}
				      ...
				      ,{field:'subDateTime', title: '租用时间', width:180,  style:'font-size: 12px;',templet: '#format_userSub_date'}
				      ,{field:'subDateTime', title: '状态', width:180,  style:'font-size: 12px;',templet: '#format_type'}

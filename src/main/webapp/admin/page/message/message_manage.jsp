...
<div class="layui-table-toolbar" style="margin-bottom: 3px; ">
	<div class="layui-btn-group">
	    ...
	    <button class="layui-btn layui-btn-sm" onclick="delSelected()"><i class="layui-icon">&#xe640;</i>删除留言</button>
 	 </div>
</div>
			...
			, element = layui.element; //元素操作
			  table.render({
			   ...
			   cols: [[
			      ...
			      ,{field:'createDateTime', title: '留言时间', width:180,  style:'font-size: 12px;'}
			      
			      ,{field:'content', title: '留言内容', width:200,style:'font-size: 12px;'}

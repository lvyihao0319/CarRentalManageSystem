...
/*修改table表格 左右内边框 为0*/
/*
.laytable-cell-1-tupian{  /*最后的pic为字段的field*/
       height: 100%;
       max-width: 100%;
   } 
*/
...
function add(){
	...
	layer.open({
	  ...
	  shade: 0.8,
	  area: [w+'px', h+'px'],
	  content: 'houtai/car/add'  //iframe的url
	});
}
...
function edit(id){
	...
	layer.open({
	  ...
	  shade: 0.8,
	  area: [w+'px', h+'px'],
	  content: 'houtai/car/edit?id='+id //iframe的url
	});
}
...
function del(ids){
	...
	$.post('admin/car/delete',{ids:ids},function(result){
		if(result.success){
			layer.closeAll();
			layer.msg('删除成功');
			reload_data();
...
<div class="layui-table-toolbar" style="margin-bottom: 3px; ">
	<div class="layui-btn-group">
		<button onclick="add()" class="layui-btn  layui-btn-sm">增加车辆</button>
